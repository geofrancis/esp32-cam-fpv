...
static const frameSizeStruct frameSizeData[] = {
  ...
  {{0x20, 0x03}, {0x58, 0x02}, {0xc4, 0x01}}, // svga 800x600, 800x452
  {{0x00, 0x04}, {0x00, 0x03}, {0x00, 0x03}}, // xga 
  {{0x00, 0x05}, {0xD0, 0x02}, {0xD0, 0x02}}, // hd
  {{0x00, 0x05}, {0x00, 0x04}, {0x00, 0x04}}, // sxga
  {{0x40, 0x06}, {0xB0, 0x04}, {0x88, 0x03}}  // uxga  1600x1200,1600x904
};
...
void prepAviIndex(bool isTL) 
{
  ...
  if (idxBuf[isTL] == NULL) idxBuf[isTL] = (uint8_t*)ps_malloc((DVR_MAX_FRAMES+1)*IDX_ENTRY); // include some space for audio index
...
bool openAvi() 
{
  ...
  FILE* f = fopen("/sdcard/current.avi", "wb");
  if (!f)
  {
    LOG("Error to opening current.avi!\n";
    return false;
  }
